...
function dictValueParserDeploy(): DictionaryValue<Deploy> {
  return {
    ...
    parse: (src) => loadDeploy(src.loadRef().beginParse()),
  };
}
...
function dictValueParserDeployOk(): DictionaryValue<DeployOk> {
  return {
    ...
    parse: (src) => loadDeployOk(src.loadRef().beginParse()),
  };
}
...
function dictValueParserFactoryDeploy(): DictionaryValue<FactoryDeploy> {
  return {
    ...
    parse: (src) => loadFactoryDeploy(src.loadRef().beginParse()),
  };
}
...
function dictValueParserChangeOwner(): DictionaryValue<ChangeOwner> {
  return {
    ...
    parse: (src) => loadChangeOwner(src.loadRef().beginParse()),
  };
}
...
function dictValueParserChangeOwnerOk(): DictionaryValue<ChangeOwnerOk> {
  return {
    ...
    parse: (src) => loadChangeOwnerOk(src.loadRef().beginParse()),
  };
}
...
function dictValueParserJettonData(): DictionaryValue<JettonData> {
  return {
    ...
    parse: (src) => loadJettonData(src.loadRef().beginParse()),
  };
}
...
function dictValueParserJettonMint(): DictionaryValue<JettonMint> {
  return {
    ...
    parse: (src) => loadJettonMint(src.loadRef().beginParse()),
  };
}
...
type BankJettonWallet_init_args = {
  $$type: "BankJettonWallet_init_args";
  owner: Address;
  jetton_master: Address;
};

function initBankJettonWallet_init_args(src: BankJettonWallet_init_args) {
  return (builder: Builder) => {
    let b_0 = builder;
    b_0.storeAddress(src.owner);
...
async function BankJettonWallet_init(owner: Address, jetton_master: Address) {
  const __code = Cell.fromBase64(
    "",
  );
  const __system = Cell.fromBase64(
    "",
  );
  let builder = beginCell();
  builder.storeRef(__system);
  builder.storeUint(0, 1);
  initBankJettonWallet_init_args({
    $$type: "BankJettonWallet_init_args",
    owner,
    jetton_master,
  })(builder);
...
const BankJettonWallet_errors: { [key: number]: { message: string } } = {
...
const BankJettonWallet_types: ABIType[] = [
  {
    name: "StateInit",
    header: null,
    fields: [
...
const BankJettonWallet_getters: ABIGetter[] = [
  {
...
const BankJettonWallet_receivers: ABIReceiver[] = [
...
export class BankJettonWallet implements Contract {
  static async init(owner: Address, jetton_master: Address) {
    return await BankJettonWallet_init(owner, jetton_master);
  }

  static async fromInit(owner: Address, jetton_master: Address) {
    const init = await BankJettonWallet_init(owner, jetton_master);
    const address = contractAddress(0, init);
    return new BankJettonWallet(address, init);
  }

  static fromAddress(address: Address) {
    return new BankJettonWallet(address);
  }

  readonly address: Address;
  readonly init?: { code: Cell; data: Cell };
  readonly abi: ContractABI = {
    types: BankJettonWallet_types,
    getters: BankJettonWallet_getters,
    receivers: BankJettonWallet_receivers,
    errors: BankJettonWallet_errors,
  };
  ...
  async send(
    ...
    message: Stake | JettonTransfer | JettonBurn | JettonInternalTransfer,
  ) {
